          ...
          <div className={`flexCenter ${css.group}`} style={{ position: "relative" }}>
            <div className={css.contact}>
              <div className={css.contactItem}>
                <a href="mailto:jekilllimarenko@gmail.com" target="blank" className={`${css.social} ${css.gmail}`}> 
                ...
                <span className={css.contactLabel}>Gmail</span>
              </div>
              <span className={css.dotDecor}></span>
              <div className={css.contactItem}>
                  <a href="https://t.me/eyeije" target="blank" className={`${css.social} ${css.telegram}`}> 
              ...
              <span className={css.dotDecor}></span>
              <div className={css.contactItem}>
                <a href="tel:+34692142247" target="blank" className={`${css.social} ${css.whatsapp}`}> 
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
